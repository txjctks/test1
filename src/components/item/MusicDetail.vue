<template>
  ...
  <div class="detailCentent" v-show="!isLyrcShow" @click="isLyrcShow = true">
    <img
    ...
    <img
      ...
      alt=""
      class="img_ar"
      :class="{ img_ar_artive: !isbtnShow, img_ar_pauesd: isbtnShow }"
    />
  </div>
  ...
  <div class="detailFooter">
    <div class="footerTop">
      ...
      <svg class="icon" aria-hidden="true">
        <use xlink:href="#icon-xiaoxixinxihuihuahuida"></use>
      </svg>
      <svg class="icon" aria-hidden="true">
  ...
  watch: {
    currentTime: function (newValue) {
      ...
      if (p) {
        console.log([p]);
        if (p.offsetTop > 225) {
          this.$refs.musicLyric.scrollTop = p.offsetTop - 225;
        }
